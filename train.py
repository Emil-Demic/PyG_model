...
for epoch in range(args.epochs):
    ...
    for i, batch in enumerate(loader):
        ...
        batch.edge_index_a = to_dense_adj(batch.edge_index_a, batch.x_a_batch)
        batch.edge_index_p = to_dense_adj(batch.edge_index_p, batch.x_p_batch)
        batch.edge_index_n = to_dense_adj(batch.edge_index_n, batch.x_n_batch)
